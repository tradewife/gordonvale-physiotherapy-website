    ...
    <div className="min-h-screen bg-transparent relative">
      ...
      <section className="section-spacing relative">
        <div className="page-container">
            ...
            <div className="space-y-8 text-black/70 text-content mt-20 sm:mt-28 md:mt-32 lg:mt-36">
              <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl font-medium leading-tight tracking-tight text-black mb-6">
